...
public class BuscarPorReferenciaOuDespesaController implements Initializable {
	...
	@FXML
	private TextField txtReferenciaOuDespesa;
	@FXML
	...
	public void onConsulta(ActionEvent evento) {
		String refOuDespesa = txtReferenciaOuDespesa.getText();
