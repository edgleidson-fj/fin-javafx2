...
-- Schema finjavafx6
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `finjavafx6` DEFAULT CHARACTER SET utf8 ;
USE `finjavafx6` ;

-- -----------------------------------------------------
-- Table `finjavafx6`.`despesa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finjavafx6`.`despesa` (
...
-- -----------------------------------------------------
-- Table `finjavafx6`.`tipopag`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finjavafx6`.`tipopag` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `finjavafx6`.`status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finjavafx6`.`status` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `finjavafx6`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finjavafx6`.`usuario` (
...
-- -----------------------------------------------------
-- Table `finjavafx6`.`lancamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finjavafx6`.`lancamento` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `finjavafx6`.`item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finjavafx6`.`item` (
